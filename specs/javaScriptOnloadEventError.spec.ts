...
import {JavaScriptOnloadEventErrorPage, TConsoleErrorData} from "@mrichforth-boilerplates/ts-playwright-boilerplate-framework/dist/pages/javascript.onload.event.error.page";
