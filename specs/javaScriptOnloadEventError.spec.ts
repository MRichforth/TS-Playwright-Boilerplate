...
import {JavaScriptOnloadEventErrorPage, TConsoleErrorData} from "@mrichforth/ts-playwright-boilerplate-framework/dist/pages/javascript.onload.event.error.page";
