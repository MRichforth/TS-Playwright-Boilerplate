# TS Playwright Boilerplate (with [**TSPB-framework**](https://github.com/MRichforth/TSPB-framework))
...
## Table of Contents
 ...
 - [**Project configuration**](#project-configuration)
     - [**@mrichforth/ts-playwright-boilerplate-framework NPM package usage**](#mrichforthts-playwright-boilerplate-framework-npm-package-usage)
...
### [**@mrichforth/ts-playwright-boilerplate-framework**](https://github.com/MRichforth/TSPB-framework) NPM package usage

This project uses the custom NPM package [**@mrichforth/ts-playwright-boilerplate-framework**](https://github.com/MRichforth/TSPB-framework) which contains page object and helpers files

Instructions on how to use this package can be found here: [**TSPB framework for TS-Playwright-Boilerplate**](https://github.com/MRichforth/TSPB-framework/blob/main/README.md)

The installation process is described in detail here: [**Usage in TS-Playwright-Boilerplate**](https://github.com/MRichforth/TSPB-framework/blob/main/README.md#usage-in-ts-playwright-boilerplate)
...
To execute a **single scenario** run the following command in the terminal:
```
npm run test-ab-testing
```
To execute **all scenarios** run the following command in the terminal:
```
...
To start a **workflow manually**, on the [**Actions**](https://github.com/MRichforth/TS-Playwright-Boilerplate/actions) tab, select workflow `(Docker-compose) Playwright Regression Tests` and from the `Run Workflow` dropdown list, select the suite required to run

![Manual workflow trigger](src/manual-workflow-trigger.png)
***
